...
@section('title')
    تقرير الفواتير - سوفتوير لادارة الفواتير
@endsection
            ...
            <div class="card mg-b-20">
                    ...
                    <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                ...
                                <select class="form-control select2" name="type" required>
                                    <option value="{{ $type_name ?? 'حدد نوع الفواتير' }}" selected disabled>
                        ...
                        <div class="row">
                            <div class="col-sm-1 col-md-1">
                                <button class="btn btn-primary buttons-copy buttons-html5">بحث</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="card-body" id="card-body">
                    <div class="table-responsive">
                        @if (isset($details))
                            <table id="example" class="table key-buttons text-md-nowrap" style="text-align: center" data-page-length='50'>
                                <thead>
                                    <tr>
