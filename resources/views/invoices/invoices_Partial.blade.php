            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="{{ url('invoices/create') }}" class="modal-effect btn btn-sm btn-primary" style="color:white">
                                                    ...
                                                    @can('تعديل الفاتورة')
                                                        <a class="dropdown-item"
                                                           href=" {{ url('edit_invoice') }}/{{ $invoice->id }}">
                                                            <i class="fas fa-pen"></i> تعديل الفاتورة
                                                        </a>
                                                    @endcan
                                                    @can('حذف الفاتورة')
...
@section('js')
    ...
    <script>
        $('#delete_invoice').on('show.bs.modal', function(event) {
            ...
            $(this).find('#invoice_id').val(invoice_id);
        });
